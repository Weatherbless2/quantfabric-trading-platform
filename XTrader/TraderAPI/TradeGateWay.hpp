...
protected:
    ...
    void UpdateOrderStatus(Message::TOrderStatus& OrderStatus)
    {
        ...
        FMTLOG(fmtlog::INF,
               "TraceID={} Stage=TraderOrderStatus Account={} Ticker={} OrderToken={} OrderRef={} OrderSysID={} Status={} Traded={} ErrorID={}",
               Utils::OrderTraceID(OrderStatus.Account, OrderStatus.OrderToken, OrderStatus.OrderRef),
               OrderStatus.Account, OrderStatus.Ticker, OrderStatus.OrderToken,
               OrderStatus.OrderRef, OrderStatus.OrderSysID, OrderStatus.OrderStatus,
               OrderStatus.TotalTradedVolume, OrderStatus.ErrorID);
        Message::PackMessage message;
    ...
    virtual void OnExchangeACK(const Message::TOrderStatus& OrderStatus)
    {
        ...
        FMTLOG(fmtlog::INF,
               "TraceID={} Stage=ExchangeAck OrderToken={} OrderRef={} OrderLocalID={} TraderLatency={}us BrokerLatency={}us ExchangeLatency={}us",
               Utils::OrderTraceID(OrderStatus.Account, OrderStatus.OrderToken, OrderStatus.OrderRef),
               OrderStatus.OrderToken, OrderStatus.OrderRef, OrderStatus.OrderLocalID,
               insert - send, broker - insert, end - insert);
    }
