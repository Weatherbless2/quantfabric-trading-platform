...
from OxQuant.pytdx.parser.ex_setup_commands import ExSetupCmd1
from OxQuant.pytdx.parser.ex_get_markets import GetMarkets
from OxQuant.pytdx.parser.ex_get_instrument_count import GetInstrumentCount
from OxQuant.pytdx.parser.ex_get_instrument_quote import GetInstrumentQuote
from OxQuant.pytdx.parser.ex_get_minute_time_data import GetMinuteTimeData
from OxQuant.pytdx.parser.ex_get_history_minute_time_data import GetHistoryMinuteTimeData
from OxQuant.pytdx.parser.ex_get_transaction_data import GetTransactionData
from OxQuant.pytdx.parser.ex_get_history_transaction_data import GetHistoryTransactionData
from OxQuant.pytdx.parser.ex_get_instrument_bars import GetInstrumentBars
from OxQuant.pytdx.parser.ex_get_instrument_info import GetInstrumentInfo
from OxQuant.pytdx.parser.ex_get_history_instrument_bars_range import GetHistoryInstrumentBarsRange
from OxQuant.pytdx.parser.ex_get_instrument_quote_list import GetInstrumentQuoteList
...
class TdxExHq_API(BaseSocketClient):
    ...
    @update_last_ack_time
    def get_instrument_info(self, start=0, count=100, category=0, market=0):
...
if __name__ == '__main__':
    ...
    with api.connect('116.205.143.214', 7727):
        ...
        log.info("查询代码列表")
        pprint.pprint(api.to_df(api.get_instrument_info(3, 47, 0, 5000)))
