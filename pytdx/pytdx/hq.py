...
import pandas as pd
from OxQuant.pytdx.base_socket_client import BaseSocketClient, update_last_ack_time
from OxQuant.pytdx.heartbeat import HqHeartBeatThread
from OxQuant.pytdx.log import DEBUG, log
from OxQuant.pytdx.params import TDXParams
from OxQuant.pytdx.parser.get_block_info import (GetBlockInfo, GetBlockInfoMeta,
                                         get_and_parse_block_info)
from OxQuant.pytdx.parser.get_company_info_category import GetCompanyInfoCategory
from OxQuant.pytdx.parser.get_company_info_content import GetCompanyInfoContent
from OxQuant.pytdx.parser.get_finance_info import GetFinanceInfo
from OxQuant.pytdx.parser.get_history_minute_time_data import GetHistoryMinuteTimeData
from OxQuant.pytdx.parser.get_history_transaction_data import GetHistoryTransactionData
from OxQuant.pytdx.parser.get_index_bars import GetIndexBarsCmd
from OxQuant.pytdx.parser.get_minute_time_data import GetMinuteTimeData
from OxQuant.pytdx.parser.get_security_bars import GetSecurityBarsCmd
from OxQuant.pytdx.parser.get_security_count import GetSecurityCountCmd
from OxQuant.pytdx.parser.get_security_list import GetSecurityList
from OxQuant.pytdx.parser.get_security_quotes import GetSecurityQuotesCmd
from OxQuant.pytdx.parser.get_transaction_data import GetTransactionData
from OxQuant.pytdx.parser.get_xdxr_info import GetXdXrInfo
from OxQuant.pytdx.parser.get_report_file import GetReportFile
from OxQuant.pytdx.parser.setup_commands import SetupCmd1, SetupCmd2, SetupCmd3
from OxQuant.pytdx.util import get_real_trade_date, trade_date_sse
try:
    # Python 3
...
if __name__ == '__main__':
    ...
    api = TdxHq_API()
    if api.connect('110.41.154.219', 7709):
        # log.info("获取股票行情")
