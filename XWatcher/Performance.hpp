...
public:
    ...
    {
        // Some host probes are optional on non-CentOS systems. Clear their
        // text fields first so a failed probe cannot expose uninitialized data.
        Utils::CopyString(ColoStatus.OSVersion, "Unknown Version");
        Utils::CopyString(ColoStatus.KernelVersion, "Unknown Version");
        ...
        Utils::CopyString(ColoStatus.UpdateTime, Utils::getCurrentTimeUs());
    }
    ...
    static void UpdateOSVersion(Message::TColoStatus& ColoStatus)
    {
        ...
        if(ret > 0)
        {
            ...
            if(vec.size() >= 5)
            {
                ...
                Utils::CopyString(ColoStatus.OSVersion, OSVersion);
            }
            else
            {
    ...
    static void UpdateKernelVersion(Message::TColoStatus& ColoStatus)
    {
        ...
        if(ret > 0)
        {
            ...
            Utils::CopyString(ColoStatus.KernelVersion, result.at(0));
        }
    }
