...
“交易对账”页读取 ATP 桥的追加日志 `runtime/data/atp-reconciliation.jsonl`，展示资金、持仓、
委托、成交、查询完成和重连恢复事件。它不写 PostgreSQL/SQLite 业务配置表，也不会修改已发布
证券范围；日志中密码和 secret 字段会被服务端过滤。
